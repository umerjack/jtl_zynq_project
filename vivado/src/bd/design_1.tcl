...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set jlt_rx_in [ create_bd_port -dir I jlt_rx_in ]
  set jlt_tx_out [ create_bd_port -dir O jlt_tx_out ]
  ...
  # Create instance: jlt_rx_fanout_0, and set properties
  set block_name jlt_rx_fanout
  set block_cell_name jlt_rx_fanout_0
  if { [catch {set jlt_rx_fanout_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $jlt_rx_fanout_0 eq "" } {
  ...
  connect_bd_net -net axi_uartlite_0_tx [get_bd_ports jlt_tx_out] [get_bd_pins axi_uartlite_0/tx]
  connect_bd_net -net jlt_rx_1 [get_bd_ports jlt_rx_in] [get_bd_pins axi_uartlite_0/rx] [get_bd_pins jlt_rx_fanout_0/jlt_rx]
  connect_bd_net -net jlt_rx_fanout_0_tx1 [get_bd_ports tx1_0] [get_bd_pins jlt_rx_fanout_0/tx1]
  connect_bd_net -net jlt_rx_fanout_0_tx2 [get_bd_ports tx2_0] [get_bd_pins jlt_rx_fanout_0/tx2]
  connect_bd_net -net jlt_rx_fanout_0_tx3 [get_bd_ports tx3_0] [get_bd_pins jlt_rx_fanout_0/tx3]
  connect_bd_net -net jlt_rx_fanout_0_tx4 [get_bd_ports tx4_0] [get_bd_pins jlt_rx_fanout_0/tx4]
  ...
  assign_bd_address -offset 0x42C00000 -range 0x00000400 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
